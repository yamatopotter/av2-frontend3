...
export const TablePacientes = () =>{ 
    ...
    const [modalData, setModalData] = useState({nomePaciente: '', matricula: ''});
    ...
    return (
        <>
                        ...
                        tableData.map((data, index)=>{
                            return (<tr key={index}>
                                ...
                                <td>
                                    ...
                                    <button onClick={()=>setModalData({nomePaciente: `${data.nome}`, matricula: `${data.matricula}`})} data-bs-toggle='modal'
            ...
            <DeleteConfirmation nomePaciente={modalData.nomePaciente} matricula={modalData.matricula} toast={toast}/>
        </>
    );
}